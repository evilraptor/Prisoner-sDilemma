...
Score Simulator(int pay_off_matrix[8][6], int game_steps_number, short game_type, int player1_place, int player2_place, int player3_place, Score score, std::vector<std::vector<char>> roundschoices, std::map<int, IStrategy*> players) {
	...
	for (int i = 0; i < game_steps_number; i++) {
		...
		RoundResult roundresult(simulationroundchoices, pay_off_matrix);
